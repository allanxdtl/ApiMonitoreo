        ...
        $(document).ready(function () {
            ...
            const GetProductos = () => {
                $.get(`${api}ProductoTerminado/List`, (data) => {
                    $("#producto").empty();
                    $("#producto").append(new Option("Seleccione un producto", "", true, true));
                    data.forEach(p => {
            ...
            $("#actualizar").click(() => {
                const id = $("#id").val();
                if (!id) return Swal.fire("Atención", "Seleccione un registro para actualizar", "info");
            ...
            $("#eliminar").click(() => {
                const id = $("#id").val();
                if (!id) return Swal.fire("Atención", "Seleccione un registro para eliminar", "info");
            ...
            $("#buscar").click(() => {
                ...
                }).fail(() => Swal.fire("Error", "No se pudo realizar la búsqueda", "error"));
            });
        });